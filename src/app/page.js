...
export default function Home() {
  ...
  // Save previous grid to localStorage
  useEffect(() => {
    if (previousGrid) {
  ...
  const downloadGrid = async () => {
    ...
    if (!showPreview) {
      await new Promise((resolve) => setTimeout(resolve, 200)); // allow layout/render
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white flex flex-col items-center justify-center">
      <div className="w-full max-w-2xl mx-auto bg-black/70 rounded-xl shadow-lg p-8 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          {images.length < 12 && (
            <>
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-5 py-2 rounded-lg font-semibold shadow"
              >
                Add Photo
              </button>
              {currentFile && (
          ...
          {images.length >= 2 && (
            <div className="flex flex-col items-center w-full mt-6 gap-4">
              <button
                ...
                className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white px-6 py-2 rounded-lg font-semibold shadow"
              >
                Preview Grid 👀
              </button>
              <button
                onClick={downloadGrid}
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-semibold shadow"
              >
                Download Dump 📥
              </button>
              {previousGrid && (
                <button
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white px-6 py-2 rounded-lg font-semibold shadow"
                >
                  View Previous Grid
                </button>
              )}
              <button
                ...
                className="bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-800 hover:to-black text-white px-6 py-2 rounded-lg font-semibold shadow"
              >
                Start New Grid
              </button>
            </div>
          ...
          {/* View Previous Grid (if no current grid) */}
          ...
          >
            <div
              ...
              className={`grid ${getGridColsClass(images.length)}`}
              style={{
                width: "600px",
                gap: 0,
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
              <div className="relative bg-black rounded-xl shadow-2xl p-4 flex flex-col items-center">
                ...
                <a
                  ...
                  className="mt-4 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-semibold shadow"
                >
                  Download Again
                </a>
              </div>
      ...
      <div className="mt-8 text-center text-gray-300 text-sm max-w-xl">
        ...
        <div className="my-4 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-4 py-2 rounded-lg shadow cursor-pointer"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path
                d="M17 19c0 1.104-.895 2-2 2H9c-1.105 0-2-.896-2-2V7h10v12zM19 7V5c0-1.104-.895-2-2-2H7C5.895 3 5 3.896 5 5v2H2v2h2v12c0 2.209 1.791 4 4 4h6c2.209 0 4-1.791 4-4V9h2V7h-3z"
                fill="#000"
              />
            </svg>
            Buy Me a Coffee
